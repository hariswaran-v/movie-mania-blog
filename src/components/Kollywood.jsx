...
const CelebCard = memo(({ celeb }) => {
  return (
    <div className="group bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
