...
const CelebCard = memo(({ celeb }) => {
  return (
    <div className="group bg-gradient-to-br from-emerald-900/20 to-gray-900 rounded-xl p-5 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-emerald-500/20 hover:border-emerald-500/40 min-w-[320px]">
...
const CelebCarousel = ({ celebrities }) => {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={prevSlide}
        className="absolute left-0 top-1/2 -translate-y-1/2 z-20 bg-emerald-600/50 hover:bg-emerald-600/70 text-white p-3 rounded-full backdrop-blur-sm transition-all duration-300 hover:scale-110 opacity-0 group-hover:opacity-100"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-0 top-1/2 -translate-y-1/2 z-20 bg-emerald-600/50 hover:bg-emerald-600/70 text-white p-3 rounded-full backdrop-blur-sm transition-all duration-300 hover:scale-110 opacity-0 group-hover:opacity-100"
          ...
          (_, index) => (
            <button
              ...
              className={`transition-all duration-300 rounded-full ${
                index === currentIndex
                  ? "w-8 h-3 bg-gradient-to-r from-emerald-500 to-emerald-600 scale-125"
    ...
    <section className="min-h-screen bg-gradient-to-br from-gray-900 via-emerald-950/20 to-gray-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          {/* Celebrity Carousel */}
          <CelebCarousel celebrities={mollywoodCelebs} />
        </div>
